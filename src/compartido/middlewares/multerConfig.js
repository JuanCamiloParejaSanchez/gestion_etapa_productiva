...
// Determinar si usar Azure Blob Storage basado en variables de entorno
const USE_AZURE_BLOB = process.env.USE_AZURE_BLOB === 'true' && process.env.AZURE_STORAGE_ACCOUNT_NAME;
...
if (!USE_AZURE_BLOB && !fs.existsSync(UPLOADS_DIR)) {
...
if (USE_AZURE_BLOB) {
    ...
    storage = multer.memoryStorage(); // Almacenar en memoria para subir a Azure
} else {
